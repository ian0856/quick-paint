...
<template>
  <aside class="h-[42vh] w-full flex flex-none flex-col overflow-auto border-b border-base bg-base px-5 pb-4.5 pt-5.5 sm:h-screen sm:w-85 sm:border-b-0 sm:border-r" aria-label="工作台控制">
